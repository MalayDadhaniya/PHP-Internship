...
<body>
    <div class="container">
        <h3 style="padding: 5px 0px 30px 0px;"><u>User List :</u></h3>
        <?php
        ...
        <table id="myTable" class="display table table-hover">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="./user-list-edit.php?id=<?php echo $row['Id']; ?>" class="btn btn-info">Edit</a>
                        <form action="insert-user.php" method="POST" style="display:inline-block;">
                            <input type="hidden" name="delete_id" value="<?php echo $row['Id']; ?>">
                            <button type="submit" name="deleteUser" value="<?php echo $row['Id']; ?>"
